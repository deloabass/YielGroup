            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  ...
                  porte en lui une symbolique forte : l'avenir, la transmission
                  et la volonté d'apporter des outils innovants au service des
                  entreprises et de leurs talents.
                </p>
                <p className="text-gray-600 mb-6">
                  Pensé comme un véritable levier de transformation, YIEL
                  accompagne les organisations dans l'optimisation de leurs
                  processus RH, la gestion des talents et la simplification des
