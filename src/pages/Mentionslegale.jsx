        ...
        <div className="bg-gradient-to-r from-[#2f365b] to-[#3a4272] text-white py-30 px-4 md:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-lg md:text-xl max-w-3xl">
              Informations juridiques concernant YIEL GROUP, éditeur de
              solutions SIRH innovantes. Dernière mise à jour : 08 avril 2025
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="md:w-1/4">
              <div className="bg-white shadow rounded-lg sticky top-24 p-4">
                <h2 className="text-[#2f365b] font-bold mb-4 pb-2 border-b">
                  Sommaire
                </h2>
            ...
            <div className="md:w-3/4">
              <div className="bg-white shadow rounded-lg p-6">
                <section id="editeur" className="mb-10">
                  <h2 className="text-2xl font-bold text-[#2f365b] mb-4">
                    Éditeur
                  </h2>
                    ...
                    <div className="w-full lg:w-1/3 bg-[#2f365b] text-white p-5 lg:p-6 flex items-center justify-center">
                      <div className="text-center py-4">
                        <svg
                          ...
                          className="h-10 w-10 sm:h-12 sm:w-12 mx-auto mb-2 sm:mb-3"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-5">
                    <div className="flex flex-col md:flex-row items-center gap-6">
                      ...
                      <div className="flex-grow text-center md:text-left">
                        <h3 className="text-xl font-bold text-[#ea532b] mb-1">
                          Stéphanie NKOMANE BITEGYE
                        </h3>
                        <p className="text-gray-600 mb-3">
                          PDG et fondatrice de Yiel Group
                        </p>
                        <div className="flex flex-col md:flex-row gap-3 items-center md:items-start">
                          <div className="flex items-center">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="h-5 w-5 mr-2 text-[#2f365b]"
                              fill="none"
                              viewBox="0 0 24 24"
                              stroke="currentColor"
                            >
                            ...
                            <a
                              ...
                              className="text-[#2f365b] hover:text-[#ea532b]"
                            >
                ...
                <section id="hebergement" className="mb-10">
                  ...
                  <div className="bg-gray-50 rounded-lg p-6 border-l-4 border-[#ea532b]">
                    ...
                    <p className="text-sm text-gray-600">
                      La conception, le développement et la maintenance du site
                      sont assurés par les équipes techniques de YIEL GROUP.
                    </p>
                  </div>
                </section>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg">
                    <div className="p-6">
                      <div className="flex items-center mb-4">
                        ...
                        <h3 className="text-xl font-semibold text-[#2f365b]">
                          Droits d'auteur et propriété
                        </h3>
                      </div>
                      <p className="mb-4">
                        L'ensemble du contenu présent sur le site Yiel (textes,
                        images, vidéos, graphismes, logos, icônes, éléments
                        visuels, etc.) est la propriété exclusive de Yiel Group
                        ou de ses partenaires et est protégé par les lois
                        internationales sur le droit d'auteur et la propriété
                        intellectuelle.
                      </p>
                      <p className="mb-4">
                        Toute reproduction, distribution, modification ou
                        utilisation du contenu sans autorisation écrite
                        ...
                        <div className="flex">
                          ...
                          <div className="ml-3">
                            <p className="text-sm text-[#2f365b]">
                              La marque YIEL, les logos associés et l'ensemble
                              des interfaces utilisateur sont des marques
                              déposées et ne peuvent être utilisés sans l'accord
                              préalable de YIEL GROUP.
                            </p>
                          </div>
                        </div>
                      </div>
                ...
                <section id="responsabilite" className="mb-10">
                  ...
                  <div className="p-6 bg-gray-50 rounded-lg">
                    <p className="mb-4">
                      Yiel Group met tout en œuvre pour assurer l'exactitude et
                      l'accessibilité des informations diffusées sur son site.
                      Toutefois, la société ne saurait être tenue pour
                      responsable des erreurs, omissions ou d'une
                      indisponibilité temporaire du service.
                    </p>
                    <p className="mb-4">
                      L'utilisateur du site reconnaît utiliser les informations
                      disponibles sous sa responsabilité exclusive.
                    </p>
                    <div className="bg-white p-4 border border-gray-200 rounded-lg">
                      <h3 className="font-medium text-[#ea532b] mb-2">
                        Limitation de responsabilité
                      </h3>
                      <ul className="list-disc pl-5 space-y-2 text-sm">
                        <li>
                          YIEL GROUP ne peut garantir l'exactitude, la précision
                        ...
                        <li>
                          YIEL GROUP ne peut être tenu responsable des dommages
                          directs ou indirects résultant de l'accès ou de
                          l'utilisation de son site.
                        </li>
                        <li>
                          La responsabilité de YIEL GROUP ne saurait être
                          engagée en cas de force majeure ou du fait
                ...
                <section id="donnees" className="mb-10">
                  ...
                  <div className="p-6 bg-white border border-gray-200 rounded-lg">
                    <p className="mb-4">
                      ...
                      <strong> YIEL GROUP</strong> est responsable du traitement
                      des données personnelles collectées sur ce site.
                    </p>
                    <h3 className="text-lg font-semibold text-[#ea532b] mb-3">
                    ...
                    <ul className="mb-6 space-y-3">
                      {[
                        ...
                        <li key={index} className="flex items-start">
                          <svg
                            className="h-5 w-5 text-[#ea532b] mr-2 mt-0.5"
                            viewBox="0 0 20 20"
                            fill="currentColor"
                          >
                            <path
                    ...
                    <div className="bg-[#2f365b] text-white p-4 rounded-lg mb-4">
                      <div className="flex items-center">
                        ...
                        <p className="font-medium">
                          ...
                          <strong>jamais revendues</strong> à des tiers.
                        </p>
                      </div>
                    </div>
                    <p className="mb-4">
                      Elles peuvent cependant être partagées avec nos
                      prestataires techniques dans le strict cadre de
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg">
                      <p className="text-sm">
                        ...
                        <a
                          ...
                          className="text-[#ea532b] hover:underline mx-1"
                        >
                        ...
                        <a
                          href="/cookies"
                          className="text-[#ea532b] hover:underline ml-1"
                        >
                ...
                <section id="droits" className="mb-10">
                  ...
                  <div className="mt-6 p-5 bg-[#2f365b] text-white rounded-lg">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-4">
                      ...
                      <div>
                        <p className="mb-2">
                          Pour exercer ces droits ou poser une question,
                          contactez-nous à :
                        </p>
                        <p>
                          <a
                            href="mailto:contact@yiel-group.com"
                            className="text-[#ea532b] font-bold hover:underline"
                          >
                            contact@yiel-group.com
                          </a>
                        </p>
                ...
                <section id="reglementaire" className="mb-10">
                  ...
                  <div className="p-6 bg-gray-50 rounded-lg border border-gray-200">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        <h3 className="font-semibold text-[#ea532b] mb-3">
                          Lois applicables
                        </h3>
                        <p className="text-sm mb-3">
                          Le site et son contenu sont régis par la législation
                          camerounaise et internationale applicable.
                        </p>
                        <p className="text-sm">
                          En cas de litige, les tribunaux compétents seront ceux
                          de Yaoundé (Cameroun), sans préjudice de la protection
                          dont les consommateurs pourraient bénéficier au titre
                          des dispositions impératives du droit applicable.
                        </p>
                      </div>
                      <div>
                        <h3 className="font-semibold text-[#ea532b] mb-3">
                        ...
                        <p className="text-sm mb-3">
                          Conformément aux dispositions en vigueur, tout
                          consommateur dispose d'un droit de recours à un
                          médiateur de la consommation en vue de la résolution
                          amiable de tout litige.
                        </p>
                        <p className="text-sm">
                          Veuillez nous contacter préalablement à toute demande
                          de médiation.
                        </p>
                      </div>
                    </div>
                    <div className="mt-6">
                      ...
                      <p className="text-sm">
                        L'utilisation du site internet YIEL GROUP implique
                    ...
                    <div className="flex flex-col md:flex-row gap-8">
                      <div className="md:w-1/2  bg-white shadow rounded-lg p-5">
                        ...
                        <p className="text-sm text-gray-600 pl-12">
                          Pour toute question concernant nos services ou pour
                      ...
                      <div className="md:w-1/2 bg-white shadow rounded-lg p-5">
                        ...
                        <p className="text-sm text-gray-600 pl-12">
                          Notre ligne téléphonique sera bientôt disponible. En
                          attendant, veuillez nous contacter par e-mail.
                        </p>
                      </div>
                    </div>
                    <div className="mt-8 bg-gray-50 p-5 rounded-lg">
                      <h3 className="font-bold text-lg text-[#2f365b] mb-3">
                        Siège social
                      </h3>
