...
import { Calendar, Search, User, Clock, Tag, ChevronRight, Filter, Bookmark } from "lucide-react";
  ...
  const blogPosts = [
    {
      ...
      excerpt: "Découvrez les meilleures pratiques pour améliorer votre processus de recrutement et attirer les meilleurs talents dans votre entreprise.",
      category: "Recrutement",
      image: "https://www.mindonsite.com/wp-content/uploads/2023/03/tendances-recrutement-2023-1024x683.jpeg",
      author: "Marie Dubois",
  ...
  const faqs = [
    {
      ...
      answer: "Si vous souhaitez partager votre expertise, envoyez-nous un email avec votre proposition d'article. Notre équipe éditoriale l'examinera et vous recontactera sous 5 jours ouvrés."
    },
    {
      id: 2,
      question: "À quelle fréquence publiez-vous de nouveaux articles ?",
      answer: "Nous publions généralement de nouveaux contenus 2 à 3 fois par semaine. Abonnez-vous à notre newsletter pour être informé des nouvelles publications."
    },
    {
      id: 3,
      question: "Comment puis-je télécharger les ressources RH ?",
      answer: "La plupart de nos ressources sont accessibles gratuitement après inscription à notre newsletter. Certains documents premium sont réservés à nos abonnés."
    }
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-lg md:text-xl text-gray-100 mb-8">
                Découvrez les dernières tendances, conseils et meilleures pratiques pour votre gestion des ressources humaines
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {featuredPosts.map((post) => (
                <div key={post.id} className="relative overflow-hidden rounded-xl shadow-md transition transform hover:-translate-y-1 hover:shadow-lg">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        <div>
                          <p className="font-medium text-[#2f365b]">{post.author}</p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredPosts.map((post) => (
                <div key={post.id} className="bg-white rounded-xl overflow-hidden shadow-md transition transform hover:-translate-y-1 hover:shadow-lg">
                  <img
                    src={post.image}
                    alt={post.title}
              ...
              <div className="flex flex-col md:flex-row items-center justify-between">
                <div className="mb-6 md:mb-0 md:mr-8">
                  ...
                  <p className="text-white text-opacity-90">
                    Inscrivez-vous à notre newsletter mensuelle pour recevoir nos meilleurs articles et conseils.
                  </p>
                </div>
                <div className="w-full md:w-auto">
                  <div className="relative">
                    ...
                    />
                    <button 
                      className="absolute right-1 top-1 bottom-1 px-6 rounded-full bg-orange-500 text-white font-medium hover:bg-orange-600 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-orange-400"
                    >
                      S'inscrire
                    </button>
                  </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-gray-50 rounded-xl p-6 border border-gray-100 hover:shadow-md transition">
                ...
                <h3 className="text-xl font-bold text-[#2f365b] mb-2">Modèles de documents</h3>
                <p className="text-gray-600 mb-4">
                  Accédez à notre bibliothèque de modèles RH : contrats, fiches de poste, évaluations...
                </p>
                <a href="#" className="flex items-center text-[#ea532b] font-medium hover:underline">
              ...
              <div className="bg-gray-50 rounded-xl p-6 border border-gray-100 hover:shadow-md transition">
                ...
                <h3 className="text-xl font-bold text-[#2f365b] mb-2">Guides pratiques</h3>
                <p className="text-gray-600 mb-4">
                  Nos guides étape par étape pour optimiser vos processus RH et gagner en efficacité.
                </p>
                <a href="#" className="flex items-center text-[#ea532b] font-medium hover:underline">
              ...
              <div className="bg-gray-50 rounded-xl p-6 border border-gray-100 hover:shadow-md transition">
                ...
                <h3 className="text-xl font-bold text-[#2f365b] mb-2">Webinaires RH</h3>
                <p className="text-gray-600 mb-4">
                  Replay de nos webinaires avec des experts sur les dernières tendances en ressources humaines.
                </p>
                <a href="#" className="flex items-center text-[#ea532b] font-medium hover:underline">
      ...
      <button 
        ...
        className="fixed bottom-8 right-8 p-3 rounded-full bg-[#ea532b] text-white shadow-lg hover:bg-[#d64a27] focus:outline-none transition transform hover:-translate-y-1 z-50"
      >
