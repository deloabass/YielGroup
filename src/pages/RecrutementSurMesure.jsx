...
function RecrutementSurMesure() {
  ...
  const recrutementSteps = [
    {
      ...
      description: "Cadrage du poste, profil recherché, contexte managérial et enjeux business",
      icon: <Target size={24} />,
      color: "bg-blue-100",
    ...
    },
    {
      ...
      description: "Publication des offres sur les bons canaux via notre ATS et premier filtrage",
    ...
    },
    {
      ...
      description: "Entretiens personnalisés, tests et vérifications de références",
    ...
    },
    {
      ...
      description: "Présentation des profils qualifiés avec argumentation détaillée",
  ...
  const integrationSteps = [
    ...
    },
    {
      ...
      description: "Programme d'accueil adapté au poste et à la culture d'entreprise",
    ...
    },
    {
      ...
      description: "Accompagnement et formation pour une prise de poste efficace",
      icon: <Award size={24} />,
      color: "bg-teal-100",
    ...
    },
    {
      ...
      description: "Évaluation régulière pendant les premières semaines dans l'entreprise",
  ...
  const advantagesList = [
    {
      ...
      description: "Réduction du temps consacré au recrutement grâce à notre processus optimisé et notre ATS",
      icon: <Clock size={24} />,
      color: "bg-[#2f365b]/10",
    ...
    },
    {
      ...
      description: "Sélection rigoureuse basée sur vos critères spécifiques et votre culture d'entreprise",
      icon: <UserCheck size={24} />,
      color: "bg-[#ea532b]/10",
    ...
    },
    {
      ...
      description: "Combinaison d'expertise humaine et de technologie pour un recrutement fluide et efficace",
  ...
  const testimonials = [
    {
      quote: "Le processus de recrutement sur mesure de YIEL nous a permis de trouver rapidement des talents parfaitement adaptés à nos besoins spécifiques en Côte d'Ivoire.",
      author: "Marie Koné",
    ...
    {
      quote: "L'accompagnement personnalisé lors de l'intégration a considérablement réduit notre turnover et amélioré la productivité de nos nouvelles recrues.",
    ...
    {
      quote: "Leur outil ATS nous a fait gagner un temps précieux dans le suivi des candidatures et la collaboration entre nos équipes RH et nos managers.",
      author: "Sarah Mensah",
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                  <span className="text-[#ea532b]">Recrutement sur mesure</span> pour une intégration réussie
                </h1>
                <p className="text-lg md:text-xl max-w-lg leading-relaxed mb-8 text-gray-200">
                  Nous sommes un cabinet de recrutement spécialisé qui accompagne les entreprises dans la sélection, 
                  l'évaluation et l'intégration durable de leurs talents, avec une solution clé en main.
                </p>
          ...
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#2f365b] mb-6">
                Vous faire <span className="text-[#ea532b]">gagner du temps</span> tout en assurant la qualité
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Nous intervenons comme une extension de votre équipe RH, pour sourcer, évaluer, 
                sélectionner et intégrer les meilleurs profils, alignés avec vos objectifs stratégiques.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              {advantagesList.map((advantage, index) => (
                ...
                >
                  <div className={`w-16 h-16 rounded-full ${advantage.color} flex items-center justify-center ${advantage.textColor} mb-6`}>
                    {advantage.icon}
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <p className="text-gray-600 mb-6">
                    Notre approche combine expertise humaine et puissance technologique pour vous offrir 
                    un recrutement personnalisable, fluide et efficace :
                  </p>
                  <ul className="space-y-4">
                    <li className="flex items-start">
                      <Check className="h-5 w-5 text-[#ea532b] mr-3 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">Recrutement personnalisé adapté à votre culture d'entreprise</span>
                    </li>
                    <li className="flex items-start">
                      <Check className="h-5 w-5 text-[#ea532b] mr-3 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">Outil digital (ATS) pour simplifier et structurer chaque étape</span>
                    </li>
                    <li className="flex items-start">
                      <Check className="h-5 w-5 text-[#ea532b] mr-3 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">Accompagnement jusqu'à l'intégration complète des recrues</span>
                    </li>
                    <li className="flex items-start">
                      <Check className="h-5 w-5 text-[#ea532b] mr-3 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">Présentation uniquement des profils qualifiés avec argumentation</span>
                    </li>
                  </ul>
                </div>
                <div className="relative rounded-lg overflow-hidden shadow-lg">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-[#2f365b]/60 to-transparent flex items-center px-8">
                    <p className="text-white text-xl font-semibold max-w-xs">
                      "Recrutez les bons profils, au bon moment, avec la bonne méthode et les bons outils"
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section id="recruitment-process" className="py-24 bg-gray-50">
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#2f365b] mb-6">
                Notre solution <span className="text-[#ea532b]">clé en main</span>
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Une méthodologie éprouvée en 4 étapes pour identifier et attirer les talents qui correspondent 
                parfaitement à vos besoins et à votre culture d'entreprise.
              </p>
            </div>
        ...
        <section id="ats" className="py-24 bg-white">
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#2f365b] mb-6">
                Application de <span className="text-[#ea532b]">Suivi des Talents</span> (ATS)
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Notre ATS intégrée simplifie et structure chaque étape du processus de recrutement, 
                de la publication de l'offre à l'intégration du candidat.
              </p>
            </div>
              ...
              <div className="lg:col-span-2 p-8 bg-gray-50 rounded-xl shadow-md">
                ...
                <div className="mt-8">
                  <p className="text-gray-700 font-medium mb-4">
                    Notre ATS est un vrai gain de temps pour vos équipes RH et vos managers :
                  </p>
                  <div className="flex items-center text-[#ea532b] font-semibold">
                    <Clock size={20} className="mr-2" />
                    <span>Fini les emails dispersés et les suivis manuels !</span>
                  </div>
                </div>
              </div>
                  ...
                  <div className="absolute inset-0 bg-gradient-to-tr from-[#2f365b]/80 to-transparent flex items-center p-8">
                    <div className="max-w-md">
                      ...
                      <p className="text-white/90">
                        Suivez en temps réel l'avancement de vos recrutements et prenez des décisions éclairées 
                        grâce à une vision globale et claire de toutes les candidatures.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="flex flex-col items-center text-center">
                      ...
                      <p className="text-gray-700 font-medium">Interface claire et ergonomique</p>
                    </div>
                    <div className="flex flex-col items-center text-center">
                      <div className="w-12 h-12 rounded-full bg-[#2f365b]/10 flex items-center justify-center text-[#2f365b] mb-3">
                        <Users size={20} />
                      </div>
                      <p className="text-gray-700 font-medium">Collaboration en temps réel</p>
                    </div>
                    <div className="flex flex-col items-center text-center">
                      <div className="w-12 h-12 rounded-full bg-[#ea532b]/10 flex items-center justify-center text-[#ea532b] mb-3">
                        <CheckCircle size={20} />
                      </div>
                      <p className="text-gray-700 font-medium">Suivi post-recrutement</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section id="integration-process" className="py-24 bg-gray-50">
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#2f365b] mb-6">
                Un parcours d'<span className="text-[#ea532b]">intégration</span> efficace
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Nous accompagnons vos nouveaux collaborateurs dès leur arrivée pour favoriser 
                leur engagement et accélérer leur montée en compétence.
              </p>
            </div>
              ...
              {integrationSteps.map((step) => (
                ...
                >
                  <div className="flex flex-col items-center text-center mb-6">
                    <div className={`w-16 h-16 rounded-full ${step.color} flex items-center justify-center ${step.textColor} mb-4`}>
                      {step.icon}
                    </div>
                    <div className="w-8 h-8 rounded-full bg-[#2f365b] text-white flex items-center justify-center font-bold mb-4">
                      {step.id}
            ...
            <div className="mt-16 bg-[#2f365b] rounded-xl p-10 shadow-xl">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-white">
                <div className="text-center">
                  <div className="text-4xl font-bold text-[#ea532b] mb-2">98%</div>
                  <p className="text-gray-300">Taux de satisfaction client</p>
                </div>
                <div className="text-center">
                  <div className="text-4xl font-bold text-[#ea532b] mb-2">350+</div>
                  <p className="text-gray-300">Recrutements réussis</p>
                </div>
                <div className="text-center">
                  <div className="text-4xl font-bold text-[#ea532b] mb-2">15</div>
                  <p className="text-gray-300">Années d'expertise</p>
                </div>
                <div className="text-center">
                  <div className="text-4xl font-bold text-[#ea532b] mb-2">92%</div>
        ...
        <section id="testimonials" className="py-24 bg-white">
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Découvrez ce que nos clients disent de notre approche de recrutement sur mesure 
                et de notre accompagnement à l'intégration.
              </p>
            </div>
                ...
                >
                  <div className="flex flex-col h-full">
                    ...
                    <div className="mt-auto flex items-center">
                      ...
                      />
                      <div>
                        <div className="font-semibold text-[#2f365b]">{testimonial.author}</div>
                        <div className="text-sm text-gray-600">{testimonial.position}</div>
                        <div className="text-sm text-[#ea532b]">{testimonial.company}</div>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <section id="sectors" className="py-24 bg-gray-50">
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Nous avons développé une expertise spécifique dans des secteurs clés 
                où les enjeux de recrutement sont particulièrement stratégiques.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {expertiseSectors.map((sector, index) => (
                ...
                >
                  <div className="flex flex-col items-center text-center">
                    <div className={`w-16 h-16 rounded-full ${sector.color} flex items-center justify-center ${sector.textColor} mb-6`}>
                      {sector.icon}
                    </div>
                    <h3 className="text-xl font-bold text-[#2f365b] mb-2">
                      {sector.title}
        ...
        <section id="engagements" className="py-24 bg-white">
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#2f365b] mb-6">
                Nos <span className="text-[#ea532b]">engagements</span> envers vous
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Nous nous engageons à respecter des standards élevés de qualité et d'éthique 
                pour vous offrir un service de recrutement exemplaire.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {engagements.map((engagement, index) => (
                ...
                >
                  <div className="flex flex-col items-center text-center">
                    <div className={`w-16 h-16 rounded-full ${engagement.color} flex items-center justify-center ${engagement.textColor} mb-6`}>
                      {engagement.icon}
                    </div>
                    <h3 className="text-xl font-bold text-[#2f365b] mb-2">
                      {engagement.title}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                  <div>
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                      Prêt à transformer votre <span className="text-[#ea532b]">processus de recrutement</span> ?
                    </h2>
                    <p className="text-lg text-gray-200 mb-8">
                      Contactez-nous dès aujourd'hui pour un diagnostic gratuit de vos besoins 
                      en recrutement et découvrez comment notre approche sur mesure peut vous aider.
                    </p>
                    <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                      <button className="px-6 cursor-pointer py-3 bg-[#ea532b] text-white font-semibold rounded-lg shadow-lg hover:bg-[#d64a27] transition-all duration-300 flex items-center justify-center">
                        Prendre rendez-vous
                    ...
                    <div className="bg-white p-8 rounded-lg shadow-lg">
                      ...
                      <form className="space-y-4">
                        ...
                        <div>
                          ...
                          <input type="tel" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm" />
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <textarea rows="3" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm"></textarea>
                        </div>
                        <div>
                          <button type="submit" className="w-full py-3 bg-[#ea532b] text-white font-semibold rounded-lg hover:bg-[#d64a27] transition-all duration-300">
                            Envoyer
                          </button>
                        </div>
                      </form>
